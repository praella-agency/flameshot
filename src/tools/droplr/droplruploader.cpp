...
void DroplrUploader::upload()
{
    ...
    urlQuery.addQueryItem(QStringLiteral("filename"), QStringLiteral("%1.png").arg(fileName).toUtf8());
    ...
    QString authCredentials = QStringLiteral("%1:%2").arg(droplrUsername).arg(droplrPassword).toUtf8().toBase64();
